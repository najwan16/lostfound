...
// PERBAIKAN: HANYA 1 PARAMETER → $sessionManager
...
<body>
    ...
    <!-- SIDEBAR --> <?php include realpath(dirname(__DIR__) . '/layouts/sidebar.php'); ?>
                    ...
                    <form method="POST" action="" id="laporanForm">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="nama_barang" name="nama_barang" class="form-control" placeholder="Contoh: Laptop Dell" value="<?= htmlspecialchars($_POST['nama_barang'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                <label class="form-label" for="lokasi">Lokasi Ditemukan <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="waktu">Waktu Ditemukan <span class="text-danger">*</span></label>
                                <input type="datetime-local" id="waktu" name="waktu" class="form-control" value="<?= htmlspecialchars($_POST['waktu'] ?? '') ?>" required>
                            </div>
                        </div>

                        <div class="mt-3">
                            <label class="form-label" for="deskripsi_fisik">Deskripsi Fisik <span class="text-danger">*</span></label>
                            <textarea id="deskripsi_fisik" name="deskripsi_fisik" class="form-control" rows="4" placeholder="Contoh: Warna hitam, ada stiker..." required><?= htmlspecialchars($_POST['deskripsi_fisik'] ?? '') ?></textarea>
                        </div>
