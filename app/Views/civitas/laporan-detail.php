...
// === PATH GAMBAR YANG AMAN & BENAR ===
$baseUpload = 'public/uploads';  // Dari root proyek

// Foto laporan
$fotoLaporan = $laporan['foto']
...
$fotoBukti = $laporan['foto_bukti'] && file_exists(__DIR__ . '/../../' . $baseUpload . '/bukti/' . basename($laporan['foto_bukti']))
    ...
    <div class="container mt-4">
        <div class="item-card">
            ...
            <div class="item-image-section">
                <img src="<?= $fotoLaporan ?>" alt="<?= htmlspecialchars($laporan['nama_barang']) ?>" class="main-image" id="mainImage">
            </div>
            ...
            <div class="item-details">
                <div>
                    ...
                    <!-- STATUS BARANG -->
                    <div class="mt-3">
                        <span class="badge <?= $laporan['status'] === 'belum_ditemukan' ? 'bg-warning text-dark' : ($laporan['status'] === 'ditemukan' ? 'bg-info text-white' : 'bg-success') ?>">
                            <?= ucfirst(str_replace('_', ' ', $laporan['status'])) ?>
                        </span>
                    </div>

                    <!-- JIKA SUDAH DIAMBIL: TAMPILKAN PENGAMBIL + BUKTI -->
