        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4">
                    ...
                    ?>
                    <a href="index.php?action=search&filter=semua&<?= http_build_query($currentParams) ?>"
                        class="btn btn-outline-primary filter-btn <?= $filter === 'semua' ? 'active' : '' ?>">Semua</a>
                    <a href="index.php?action=search&filter=hilang&<?= http_build_query($currentParams) ?>"
                        class="btn btn-outline-warning filter-btn <?= $filter === 'hilang' ? 'active' : '' ?>">Barang Hilang</a>
                    <a href="index.php?action=search&filter=ditemukan&<?= http_build_query($currentParams) ?>"
