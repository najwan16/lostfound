            ...
            <div class="col-md-12">
                <div class="input-section">
                    <div class="form-wrapper">
                        <!-- FORM MULAI DI SINI -->
                        <form method="POST" action="../index.php?action=submit_laporan"
                            class="report-form" enctype="multipart/form-data">
            
                            <!-- FOTO BARANG (DI DALAM FORM!) -->
                            ...
                            <!-- TOMBOL SUBMIT -->
                            <button type="submit" class="btn btn-submit w-100">Buat Laporan</button>
                        </form>
                        <!-- FORM SELESAI -->
                    </div>
                </div>
