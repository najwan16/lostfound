            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="center-nav navbar-nav">
                    ...
                    <?php if ($controller->getSessionManager()->get('userId')): ?>
                        <!-- Cari menuju riwayat_laporan -->
                        <a class="nav-link <?php echo $currentPage === 'riwayat_laporan' ? 'active' : ''; ?>" href="../index.php?action=riwayat_laporan">Cari</a>
                        <!-- Laporan menuju laporan_form -->
